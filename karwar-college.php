        ...
        <!--</div>-->
            ...
            <!--<div class="row">-->
                <ul class="nav nav-pills">
                    ...
                    <div class="col-sm-3">
                        <li class="nav-item">
                            <a href="haveri-college.php" class="nav-link" style="border:1px solid #E87A00;width:100%;text-align:center;font-size:16px;font-family:Enriqueta;font-weight:bold">Haveri</a>
                        </li>
                    </div>
                    <div class="col-sm-3">
                        <li class="nav-item">
                            <a href="karwar-college.php" class="nav-link active" style="border:1px solid #E87A00;width:100%;text-align:center;font-size:16px;font-family:Enriqueta;font-weight:bold">Karwar</a>
                        </li>
                    </div>
                </ul>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 style="font-family:Domine; font-weight:600;font-size:19px">Affiliated Colleges Karwar</h3>
                        <div class="table-responsive">
                            ...
                            <?php 
				$qry="select * from aff_colleges where city='Karwar'";
				...
				?>
				    <tr>
				    <td><?php echo $cnt++;?></td>
                    <td style="width:30%;font-weight:bold;text-align:left"><?php echo str_replace(";",",",$row['name']); ?></td>
