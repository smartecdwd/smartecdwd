        ...
        <div class="container">
            <div class="row border_around p-3 text-justify">
                ...
                <div class="col-sm-9 director_img">
                    ...
                    <h5 class="my-5">CONTACT US</h5>
                    <p class="bodytext" style="font-family:Signika;font-size:16px;color:#000;margin:10px;">
                        Karnataka University Post Graduate Centre, Karwar<br />
                        Administrator,<br />
                        Department Phone: 08382-225372<br>
                        Department KUD mail ID:<a href="mailto:kupgcntrkwr@gmail.com">kupgcntrkarwar@gmail.com</a> 
                    </p>
