...
" style="background-color:#e1ebea">
                ...
                <div class="vertical-menu" style="width:100%">
                   <!--  <a href="index.php">Home</a> -->
					...
					<a href="SAIF.php" class="active" >SAIF</a>
            ...
            <div class="col-md-9 col-sm-6 director_img">
                ...
                <br>
	            <p>Sophisticated Analytical Instrument Facility (SAIF), was established at the Karnatak University, Dharwad in 2014 with the financial support from the Department of Science and Technology (DST), Government of India, with the following objectives:</p>
	            <ul style="font-family:Average;font-size:16px;color:#000;">
	                <li>To provide services of facilities of sophisticated analytical instruments to scientists and academicians from academic institutes, R&D laboratories and industries to enable them to carry out measurements for R&amp;D work.</li>
                	<li>To acquire and develop capability for preventive maintenance and repair of sophisticated instruments.</li>
                	<li>To organize short term courses/workshops on the use and application of various instruments.</li>
		        </ul>
	            <br>
	            <p><b>SAIF centre houses the following instruments: </b></p>
	            <ol style="font-family:Average;font-size:16px;color:#000;">
                	<li>400 MHz FT-NMR Spectrometer</li>
                	<li>SEM with EDS & essential sample preparation accessories</li>
                ...
                <div class="table-responsive">
		            <table width="80%"  id="customers">
                        ...
                        <tr>
                            ...
                            <td>Mr. Pavan Bennur</td>
                            <td>400 MHz FT-NMR and CD Spectrometer</td>
                            <td>7795979950<br> 111994benz@mail.com</td>
                        </tr>
                        <tr>
                            <td align="center">2</td>
                            <td>Mr. Raju Shivalli</td>
                            <td>SEM/SEM-EDS</td>
                            <td>8792425612<br>
                                rajanagouda@mail.com
                            </td>
                        </tr>
                        <tr>
                            <td align="center">3</td>
                            <td>Mr. Akash Badami</td>
                            <td>X-ray Diffractometer(Powder)</td>
                            <td>8050122306<br>
                                akashcool388@gmail.com
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <br>
                <h5 style="text-align:center "><b>ANALYSIS CHARGES FOR SAIF INSTRUMENTS</b></h5>
                ...
                <div class="table-responsive">
                    <table width="80%"  id="customers">
                        <tr style="font-size:13px">
                            ...
                            <th colspan="3" style="text-align:center">Charges per sample in Rs.</th>
                        </tr>
                        <tr style="font-size:13px">
                            <th>Internal User(KUD Students)</th>
                            <th>External Users (Students from other Colleges/Institutions/Universities)</th>
                ...
                <h5 style="text-align:center "><b>Instrument facilities available at</b></h5>
                <h6 style="text-align:center;font-size:15px "><b>SOPHISTICATED ANALYTICAL INSTRUMENT FACILITY (SAIF), <br>
                KARNATAK UNIVERSITY, DHARWAD.</b></h6>
                ...
                <div class="table-responsive">
                    <table width="100%"  id="customers">
                        <tr style="font-size:13px">
                            ...
                            <th>Instrument</th>
                            <th>Make/Model</th>
                            <th>Major Specifications / Accessories available</th>
                            <th>Type of measurement / Analysis available</th>
                        </tr>
                        <tr style="font-size:12px;">
                            <td align="center">1</td>
                        ...
                        <tr style="font-size:12px;">
                            <td align="center">2	</td>
                            <td>X-ray Diffractometer (Powder)</td>
                            <td>Rigaku Smartlab SE </td>
                            <td>Fully automated computerized powder XRD; X-ray tube: CuAngular range (2&theta;) : 2&deg; to 150&deg; </td>
                            <td>2&theta; vs intensity plots / X-ray diffractograms; Quantitative analysis and other studies including phase identification, unit cell parameter determination, Particle
                                size determination etc.
                            </td>
                        </tr>
                        <tr style="font-size:12px;">
                            <td align="center">3</td>
                            <td>Scanning Electron Microscope with EDS </td>
                            <td>Jeol JSM / JSM-IT500LA </td>
                            <td>Magnification up to 3,00,000 X Resolution : 3nm Acc. Voltage up to 30kV Max. specimen size: 200mm Dia X 75mm height Fully computer controlled
                                Carbon, Gold coating</td>
                            <td>Surface topographic / morphological studies of microstructures on bulk specimens of biological or other materials ; SEI, BEI images; image Analysis etc.</td>
                        </tr>
                        <tr style="font-size:12px;">
                ...
                <br><br>
                <h4 style="font-family:Alice;font-size:18px;color:#0074B7;"><b>CONTACT US</b></h4>
                <p style="font-family:Signika;font-size:16px;color:#000;margin:10px;"><b>SOPHISTICATED ANALYTICAL INSTRUMENT FACILTY (SAIF)</b><br>
                    KARNATAK UNIVERSITY, DHARWAD<br>
                    Pavatenagar, Dharwad-580 003<br>
                    E-mail : <a href="saifkud@gmail.com">saifkud@gmail.com</a> or <a href="usicofficekud@rediffmail.com">usicofficekud@rediffmail.com</a><br> phone : 0836-2215295<br>
                </p>
            </div>
        </div>
    </div>
