<?php
    ...
    $qry="select * from adm_page where design like 'Chancellor'";
    $res=mysqli_query($conn,$qry);
     $nm="";$dsc="";$imgc="";$fid="";$qu="";$mo="";
...
<link href="https://fonts.googleapis.com/css2?family=Domine&family=Kanit:wght@300&family=PT+Serif&display=swap&family=Trirong" rel="stylesheet" />
	  ...
	  <h5 style="text-align:center;color:#BB6464;height:50px;padding:20px;font-size:17px;border-bottom:2px solid #BB6464;font-family:Alice"><b>ADMINISTRATION</b></h5>
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               ...
               <a href="chancellor.php" class="active">Chancellor</a>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div id="home" class="container tab-pane active"><br>
        <h3 style="font-family:Trirong;color:#000; font-weight:600;text-align:center">Chancellor</h3>
            <div class="row">
                  ...
                  <div class="administration">
                    <center><h3 style="height:50px;font-family:'Enriqueta';background-color:#e1ebea;font-size:100%;padding:8px;border-right:5px solid #BB6464;border-left:5px solid #BB6464 ;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:80%"><strong><?php echo $nm; ?></strong></h3></center>
                        ...
                        <?php 
                            ...
                            <?}else{?>
                                <button class="btn2 view_btn"><a href='<? echo $mo;?>' target="_blank">More Details</a></button>
                            <?}
                        ?></div>
                  </div>
