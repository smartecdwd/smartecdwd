<?php
    session_start();
    error_reporting(0);
    //require('db_con_rev_pg.php');
    include 'db_con_res.php';
    
    if(isset($_REQUEST['wth'])){
       echo "<script>
                document.getElementById('message').innerHTML='M.Sc. MATHEMATICS IV SEM RESULT HAS BEEN WITHDRAWN DUE TO TECHNICAL PROBLEM';
...
<script>
    function chk_code(){
        if(document.getElementById('cou').value=="159")
        {
            document.getElementById('message').innerHTML='M.Sc. MATHEMATICS IV SEM RESULT HAS BEEN WITHDRAWN DUE TO TECHNICAL PROBLEM';
            document.getElementById('message').style.visibility='visible';
        }
        ...
        <div class="col-sm-12">
            ...
            <div class="tab-content clearfix">
                 <div class="container tab-pane active">
                   <form method="post" action="result_pg.php">
                    <!--<form method="post" action="#">-->
                        ...
                        <div class="row g-3 m-5">
                            <div class="col-sm-8 mx-auto text-center my-4 d-flex justify-content-center">
                                <span id="message" class="alert-danger text-black display-block p-5" style="visibility:hidden;font-size:15px;font-weight:bold">
