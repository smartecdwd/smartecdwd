  ...
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> 
	 ...
	 <script>
	    function add_rec()
	    {
	        window.location.href='fac_pub_add.php';
	    }
	</script>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php $_SESSION['branch'];?> - Achievements</h1>
          </div>
        </div>
      </div>
    </section>
				...
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                	...
                	<div class="row" style="margin-top: 10px">
                        <div class="col-12">
					        ...
					        <?php
                                $qry="select * from vw_fac_ach where branch='" . $_SESSION['branch']."' order by dname";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td style='text-align:center'><a href='fac_ach_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_ach_view.php?did=".$row['fhid']."&dp='dpt'><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_ach_edit.php?did=".$row['fhid']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_ach_del.php?did=".$row['fhid']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                }
                            ?>
					    </table>
					</div>
