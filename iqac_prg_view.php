...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Programme Specific Outcome </title>
    <meta charset="utf-8">
                               ...
                               <form action="#" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <tr>
                                   	            <td style="font-weight:bold;font-size:18px">IQAC - Programme Specific Outcomes</td>
                                   	        </tr>
                                   	        
                                   	    </table>
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                   	            $qry="select * from iq_prg_file order by fname "; // where iq_adid=".$fid;
    
                                                $res=mysqli_query($conn,$qry);
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='iqac/prg/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
