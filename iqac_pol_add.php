...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Policies</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_pol.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Policies & Guidelines</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_pol_add.php" method="post" enctype="multipart/form-data">
						            ...
						            <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_pol.php" style='color:#fff'>Cancel</a></button>
                      ...
                      <div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate">
					        ...
					        <div class="vertical-menu" style="width:100%;font-family:exo">
								...
								<a href="iqac_pol.php" class="active">Policies and Guidelines</a>
    ...
    if(isset($_POST['submit']))
    {
        ...
        for($i=0;$i<5;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_pol_file (fname) values('$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
        echo "<script>window.location.href='iqac_pol.php';</script>";
    }
?>