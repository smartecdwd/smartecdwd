                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <div class="row">
							...
							<div class="mr-auto text-center email"><?php echo $row['fname'];?></div>
							<div class="mr-auto text-center phone"><?php echo $row['design'];?></div>
							<div class="mr-auto text-center phone"><?php echo $row['dname'];?></div>
							<?php
							...
							<div class="mr-auto text-center phone"><a href='dept/faculty/<?php echo $row1['fname'];?>'>View Profile</a></div>
                                   ...
                                   <div class="col-lg-4 mb-4">
                                    <div class="card">
                                        <div class="card-body" style="text-align:center">
                                            <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['pimg']); ?>" style="width:100px" />
                                            <h3 style="text-align:center;"><?php echo $row['fname'];?></h3>
                                            <h4 style="text-align:center"><?php echo $row['design'];?></h4>
                                            <h3 style="text-align:center"><?php echo $row['dname'];?></h3>
                                        </div>
                                         <div class="card-footer">
                                            ...
                                            ?>
                                                <a href='dept/faculty/<?php echo $row1['fname'];?>'>View Profile</a>
                                         </div>
                                    </div>
                                    </div>
                                <?php
                ...
                <div id="menu3" class="container tab-pane"><br>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <?php
                                $nid=$_REQUEST['nid'];
                                $qry="select * from fac_research where did=".$nid."";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
                ...
                <div id="menu4" class="container tab-pane"><br>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                              <?php
                                $nid=$_REQUEST['nid'];
                                $qry="select * from fac_act where did=".$nid."";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
 ...
 <div id="menu5" class="container tab-pane"><br>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <?php
                                $nid=$_REQUEST['nid'];
                                $qry="select * from fac_ach where did=".$nid."";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
