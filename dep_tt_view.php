      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $dn; ?> - Syllabus</h1>
                                   	...
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='dept/tt/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
