...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Gallary</title>
    <meta charset="utf-8">
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_gal_add.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Title</label>
                                        <input type="text" name="ft" class="form-control" style="font-size:14px">
						            </div>
                                    <div class="form-group">
						            ...
						            <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_gl.php" style='color:#fff'>Cancel</a></button>
    ...
    if(isset($_POST['submit']))
    {
        ...
        for($i=0;$i<5;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_gal_file (fname,ftitle) values('$file','$ft')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
        echo "<script>window.location.href='iqac_gl.php';</script>";
    }
?>