        ...
        <!--</div>-->
            ...
            <!--<div class="row">-->
                <ul class="nav nav-pills">
                    <div class="col-sm-3">
                        <li class="nav-item">
                            <a href="affiliated-college.php" class="nav-link active" style="border:1px solid #E87A00;width:100%;text-align:center;font-size:16px;font-family:Enriqueta;font-weight:bold">Dharwad</a>
                        </li>
                    </div>
                    <div class="col-sm-3">
                        <li class="nav-item">
            ...
            <br>
                <div class="row">
                    <div class="col-sm-12">
                        <h3 style="font-family:Domine; font-weight:600;font-size:19px">Affiliated Colleges Dharwad</h3>
...
<?php 
				$qry="select * from aff_colleges where city='Dharwad'";
