...
<section class="section1">
 ...
 <div id="menu5" class="container tab-pane"><br>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                           echo "<tr><td><a href='https://smartechd.online/kud/admin_panel/dept/adm/". $row['fname']."' style='color:red'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td><a href='https://smartechd.online/kud/admin_panel/dept/fee/". $row['fname']."' style='color:red'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td><a href='https://smartechd.online/kud/admin_panel/dept/app/". $row['fname']."' style='color:red'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td><a href='https://smartechd.online/kud/admin_panel/dept/syll/". $row['fname']."' style='color:red'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                           echo "<tr><td><a href='https://smartechd.online/kud/admin_panel/fac/prof/". $row['fname']."' style='color:red'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
	...
	<div id="menu16" class="container tab-pane"><br>
          ...
          <div class="row">
            <div class="col-lg-12">
                <table class="table table-striped" style="width:100%;color:#000;border:1px solid #3579DC;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                        ...
                        <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    echo "<td>".$row['ph1']."<br>". $row['ph2']."</td>";
                                    echo "<td>".$row['email']."</td>";
                                    echo "<td>".$row['ad_no']."</td>";
                                    echo "<td>".$row['ac_yr']."</td>";
                                    echo "<tr>";
