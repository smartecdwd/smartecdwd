        ...
        <!--</div>-->
            ...
            <!--<div class="row">-->
                <ul class="nav nav-pills">
                    ...
                    <div class="col-sm-3">
                        <li class="nav-item">
                            <a href="gadag-college.php" class="nav-link active" style="border:1px solid #E87A00;width:100%;text-align:center;font-size:16px;font-family:Enriqueta;font-weight:bold">Gadag</a>
                            </li>
                    </div>
                    <div class="col-sm-3">
                        <li class="nav-item">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 style="font-family:Domine; font-weight:600;">Affiliated Colleges Gadag</h3>
                <div class="table-responsive">
                            ...
                            <?php 
				$qry="select * from aff_colleges where city='Gadag'";
