      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px">Department Overiews</h1>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="col-12">
                        <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            <tr style="background-color:#9D84B7;color:#fff;text-align:center">
                                ...
                                <td style="width:90%">Department Name </td>
                               <!-- <td>View</td>
                                <td>Edit</td>
                                <td>Delete</td>-->
                            </tr>
                            <?php
                                ...
                                if(isset($_SESSION['branch']))
                                {
                                    $qry="select * from dep_mas where branch='". $_SESSION['branch']."' order by dname";
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                    {
                                        ...
                                        echo "<td><a href='dep_sel.php?did=".$row['did']."' style='color:#1863D6'>".$row['dname']."</a></td>";
