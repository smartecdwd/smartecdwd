                                    ...
                                    <div class="tab-content clearfix">
                                        <div id="home" class="container tab-pane active"><br>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <h5 class="mt-3"> Ph. D. AWARDEES</h5>
                                                        <?php
                                                            //$nid=$_REQUEST['nid'];
                                                            $qry="select * from vw_fac_rea where did=".$nid." and rea_typ='Ph.D Awardees'";
                                                            $res=mysqli_query($conn,$qry);
                                                            $cnt=1;
                                                            $fid="";
                                                            while($row=mysqli_fetch_assoc($res))
                                                            {
                                                                ...
                                                                line-height:1.6'>".$row['rea_det']."</div>";
                                                                    ...
                                                                    <table id="customers" style="width:80%;" align="center">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            while($row=mysqli_fetch_assoc($res))
                                                                            {
                            		                                            ...
                            		                                            echo "<tr><td style='text-align:center; width:10%;'>1.</td>".
                            		                                            "<td><a href='https://www.kud.ac.in/admin_panel/fac/reas/". $row['fname']."' style='text-transform:capitalize;color:blue' target='_blank'>". $ft[0] ."</a></td></tr>";
