...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Best Practices</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Best Practices</h1>
          </div>
        </div>
      </div>
    </section>
				...
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            <tr>
                                <td><a href="iqac_bp_add.php"><img src="images/add1.png"> </a></td>
                            </tr>
					        <?php
                            ...
                            <tr style="text-align:center">
                                <td style="text-align:left;color:#3229DE;font-weight:bold">IQAC Best Practice</td>
                                <td><a href="iqac_bp_view.php"><img src="images/v2.jpg"> </a></td>
                                <td><a href="iqac_bp_edit.php"><img src="images/ed4.png" style="width:25%"></a></td>
                                <td><a href="iqac_bp_del.php"><img src="images/del3.png" ></a></td>
						    </tr>
						   <?php }
						   ?>
					    </table>
