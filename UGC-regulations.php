           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="UGC-regulations.php" class="active">Regulations / Guidelines / Ordinance</a>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        <h2 class="title_head" style="font-family:Trirong;text-align:center">Regulations / Guidelines / Ordinance</h2>
        <hr>
        <div class="row">
            <div class="col-md-12">
