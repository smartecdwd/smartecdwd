<?php
    ...
    $did=$_SESSION['did'];
   // $_SESSION['did']=$did;
    $qry="select * from vw_dep_file where did=".$_SESSION['did'];
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px"><?php echo $_SESSION['dname']; ?> - History & Development</h1>
                        ...
                        <div class="col-12">
                               <form action="dep_upd.php" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?php
                           	                    $qry="select * from dep_mas_file where did=".$_SESSION['did'];
                                                ...
                                                {
                           	                        echo "<tr>";
                           	                        echo "<td><a href='dept/branch/". $row['fname']."' target='_blank'style='color:#1f75fe'>". $row['fname']."</a></td> ";
                           	                        echo "</tr>";
                           	                    }
                           	                ?>
                                   	            </td>
