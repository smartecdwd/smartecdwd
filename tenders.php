            ...
            <section class="section1">
                <div class="container">
                    <nav class="nav nav-tabs nav-justified">
                        ...
                        <a class="nav-item nav-link active" data-toggle="tab"  href="#menu4" style="font-family:Enriqueta;"><b>Tenders</b></a>
            ...
            <div class="row">
              ...
              <tr>
			   ...
			   <?php
                ...
                <div id="menu4" class="tab-pane  active mt-4">
              ...
              <tr>
			   ...
			   <?php
                ...
                <div id="menu6" class="tab-pane mt-5">
                            <div class="row">
                                <div class="col-lg-12">
