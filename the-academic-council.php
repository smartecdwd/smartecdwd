      ...
      <div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Academic Council Members</li>
          </ol>
        </nav>
      </div>
    </div>
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="the-academic-council.php" class="active">The Academic Council</a>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div id="home" class="container tab-pane active">
        ...
        <h3 style="font-family:Trirong; font-weight:600;color:#000;text-align:center">Academic Council Members</h3>
               <!-- <h4 class="pt-2">List of Member of Academic Council (As on 07.06.2021)</h4> -->
            <div class="row">
                <table style="width:100%;color:#000" id="customers">
                        ...
                        <?php
                            $qry="select * from adm_mem where design like 'Academic Council' order by vord";
