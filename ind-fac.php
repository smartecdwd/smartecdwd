           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%;height:-101%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="ind-fac.php" class="active">Individual Faculty Projects</a>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        <h2 class="title_head" style="font-family:Domine;text-align:center">Individual Faculty Projects</h2>
        <hr>
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
			            <table id="customers" style="width:80%" align="center">
			                <tr>
			                    <th>Sl. No.</th>
			                    <th>Individual Faculty Projects</th>
			                </tr>
                            <tr>
                                <td class="text-center" width="50">1</td>
                                <td width="540"><a href="https://www.kud.ac.in/file_upload/research/04 Individual Faculty Projects.pdf" target="_blank">Individual Faculty Projects</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
