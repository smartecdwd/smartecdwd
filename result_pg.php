<?php
    ...
    //else if($deg1=='PG')
        $qry="select stream,degree,course from course_pg where course=$cou";
   ...
   // echo $qry;
    ...
    /*if($cde=="159")
    {
        echo "<script>window.location.href='result_pg_m.php?wth=true';</script>";
    }*/
?>
                        ...
                        <div class="row">
                            <div class="col-sm-10 mx-auto">
                                <?php
                                    ...
                                    if($cnt==0)
                                    {
                                        echo "<script>window.location.href='result_pg_m.php?msg=true';</script>";
                                    }
        							?>
        							<div class="table-responsive">
                                        <table id="customers" style="width:80%;font-size:12px;font-family:Average;padding-left:3px" align="center">
                                    <tr>
