      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:8px">Notification</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
			    ...
			    <div class="col-12">
                    <button id="btnAdd" type="button" class="btn btn-success" onclick="add_noti()">Add New Record</button>
                    
                </div>
                        
				<div class="container">
				    <br><br>
				    <form method="post" action="noti_del.php">
				        <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size:10pt">    
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="width:50%;font-size:9pt">Notification Name </th>
                                <th style="font-size:9pt;width:10%">Published On </th>
                                <th style="font-size:9pt">Status</th>
                                <th style="font-size:9pt">Type</th>
                                <th style="font-size:9pt">View</th>
                                <th style="font-size:9pt">Edit</th>
                                <th style="font-size:9pt">Delete
                                </th>
                            </tr>
                        <thead> 
                        <tfoot>
                        ...
                        <tbody>
                            <?php
                                $qry="select * from notification order by ndate desc";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td style='text-align:center'>".$row['nstatus']."</td>";
                                    echo "<td style='text-align:center'>".$row['ntype']."</td>";
                                    echo "<td style='text-align:center'><a href='noti_disp.php?nid=".$row['nid']."' ><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='noti_edit.php?nid=".$row['nid']."'><img src='images/ed4.png' style='width:20px'> </a></td>";?>
                                    <td style='text-align:center'>
                                            <input class='form-check-input' type='checkbox' name='ids[]' value='<?php echo $row['nid']; ?>'>  </td>
                                <?php
                                    echo "</tr>";        
