      ...
      <div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Syndicate Members</li>
          </ol>
        </nav>
      </div>
    </div>
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="chairperson-Of-departments.php">Chairperson of Departments</a>
...
<table width="100%" class="table table-striped table-responsive" id="customers">
        <tbody>
		<tr>
                <th colspan="3" align="center">
                    &nbsp;&nbsp;List of Members of Syndicate K.U. Dharwad. (As on 14.07.2021)
                </th>
            </tr>
            ...
            <tr>
                ...
                <td>
                   Sri. Ravikumar Maliger<br />
                   (Government Nominee)<br />
                   Basavaratna, 1st Main, 8th Cross,<br />
                   Kalyan nagar, <br />
                   Dharwad-580007  <br />
                   Ph: 9742722287 <br />
                   email: <a href="mailto:ravikumar.maliger@gmail.com">ravikumar.maliger@gmail.com</a>                  
                </td>
				<td><img src="image/ravikumar.jpg" width="180" height="180" style="border: 5px solid #dcd7d7;"/></td>
            </tr>
