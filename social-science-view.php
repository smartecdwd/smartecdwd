...
<section class="section1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                           <div class="row">
							...
							<h4 class="text-center mr-auto mt-4" style="font-family:Domine;text-align:center; border-left:none;"><?php echo $row['fname'];?></h4>
							...
							<div class="text-center mr-auto mt-1" style="font-family:Domine;text-align:center; font-size:14px;"><i class="fa fa-envelope"></i>&nbsp;<?php echo $row['email'];?></div>
							
							
							
							
							<div class="text-center mr-auto mt-2" style="font-family:Domine;text-align:center">
                ...
                <div id="menu3" class="container tab-pane"><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <?php
                                $nid=$_REQUEST['nid'];
                                $qry="SELECT * FROM vw_fac_rea where did=".$nid ." and frid=3";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
                 ...
                 <div id="menu4" class="container tab-pane"><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <?php
                                $nid=$_REQUEST['nid'];
                                $qry="SELECT * FROM vw_fac_act where did=".$nid;// ." and frid=3";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
 ...
 <div id="menu5" class="container tab-pane"><br>
	 ...
	 <div id="menu8" class="container tab-pane"><br>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <?php
                                $nid=$_REQUEST['nid'];
                                $qry="select * from vw_dep_fac where did=".$nid."";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                           echo "<tr><td style='width:5%;text-align:center;'>".$cnt++."</td>
		                           <td><a href='https://smartechd.online/kud/admin_panel/dept/adm/". $row['fname']."' style='color:#0198e1'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td style='width:5%;text-align:center'>".$cnt++."</td><td><a href='https://smartechd.online/kud/admin_panel/dept/fee/". $row['fname']."' style='color:#0198e1'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td style='width:5%;text-align:center'>".$cnt++."</td><td><a href='https://smartechd.online/kud/admin_panel/dept/app/". $row['fname']."' style='color:#0198e1'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr><td style='width:5%;text-align:center'>".$cnt++."</td><td><a href='https://smartechd.online/kud/admin_panel/dept/syll/". $row['fname']."' style='color:#0198e1'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
            ...
            <div class="col-lg-12">
              ...
              <?php
                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
		                           echo "<tr><td style='width:5%;text-align:center'>".$cnt++."</td><td><a href='https://smartechd.online/kud/admin_panel/fac/prof/". $row['fname']."' style='color:#0198e1'>". $row['fname'] ."</a></td></tr>";
                                }
                            ?>
                                </table>
        </div>
	...
	<div id="menu16" class="container tab-pane"><br>
          ...
          <div class="row">
            <div class="col-lg-12">
                <table class="table table-striped table-bordered" style="width:100%;color:#000;border:1px solid #3579DC; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
               	        <tr style="padding:8px;background-color:#3579DC;color:#fff;font-family:'work sans';font-size:14px;text-align:center;height:25px;border-top-left-radius:8px">
               	            <th>Sl. No</th>
               	            <th>Reg No</th>
               	            <th>Name</th>
               	            <th>Address</th>
                        ...
                        <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    echo "<td style='text-align:center;'>".$row['reg_no']."</td>";
                                    echo "<td style='text-align:center;'>".$row['sname']."</td>";
                                    echo "<td style='text-align:center;'>".$row['address']."</td>";
                                    echo "<td style='text-align:center;'>".$row['ph1']."<br>". $row['ph2']."</td>";
                                    echo "<td style='text-align:center;'>".$row['email']."</td>";
                                    echo "<td style='text-align:center;'>".$row['ad_no']."</td>";
                                    echo "<td style='text-align:center;'>".$row['ac_yr']."</td>";
                                    echo "<tr>";
...
<h4 style="margin-top:12px !important;"><a href="social-science.php" style="font-family: 'Jockey One', sans-serif; font-size:14px"><i class="fa fa-caret-left"></i>&nbsp;&nbsp;BACK TO PAGE</a> </h4>
