...
<h2 style="font-family:Domine; font-weight:600; text-align:center;font-size:26px">Faculty of Arts</h2>
		...
		<?php
				...
				$qry="select * from dep_mas where branch='Arts' order by dname";
