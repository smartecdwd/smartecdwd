...
?>
    ...
    <style>
        ...
        .sidebar{
            background-color:#fff;border:1px solid #005b96;
        }
    </style>
                                        ...
                                        <div id="home" class="container tab-pane active"><br>
                                            <div class="row">
                                                <div class="col-sm-3 sidebar">
	                                                <!--<h5 class="mb-3" style="text-align:center;color:#145DA0;height:50px;padding:20px;font-size:17px;border-bottom:2px solid #145DA0;font-family:Alice"><b>DEPARTMENTS</b></h5>-->
                                                ...
                                                <div class="col-sm-9">
                                                    <h5 class="mt-3">ABOUT THE DEPARTMENT</h5>
                                                    <?php
                                                        //$nid=$_REQUEST['nid'];
                                                    ...
                                                    <table class="table table-bordered mt-3" style="width:100%;background-color:#eee">
                                                        <?php
