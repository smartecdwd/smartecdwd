           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
                ...
                <a href="exam.php" class="active">Apply For Convocation 2023 </a>
            </div>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        <h2 class="title_head" style="font-family:Domine;text-align:center">Exam</h2>
        <hr>
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table id="customers" style="width:80%" align="center">
                            <tr>
                                <th colspan="2" class="text-center" width="640">Details</th>
                            </tr>
                            <tr>
                                <td class="text-center" width="50">1</td>
                                <td width="540"> 
                                   <a href="https://kudconvocation.aargeessoftware.com/" target="_blank">APPLY FOR CONVOCATION 2023</a>
                                </td>
                            </tr>
                        </table>
                    </div>
