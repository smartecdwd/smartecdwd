                            ...
                            <div class="tab-content clearfix">
                                <div id="home" class="container tab-pane active"><br>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <h5 class="mb-3">JRF / NET / SLET QUALIFIED STUDENTS</h5>
                                            <?php
                                                $qry="select * from vw_dep_qstd where did=".$nid;
                                                $res=mysqli_query($conn,$qry);
                                                $cnt=1;
                                                $fid="";
                                                while($row=mysqli_fetch_assoc($res))
                                            ...
                                            ?>
                                                    <div class="table-responsive my-3">
                                                        <table class="table table-bordered" id="customers" width="100%" align="center">
                            								<tr>
                            					            ...
                            					            <?
                                                                while($row=mysqli_fetch_assoc($res))
                                                                {
                                		                            ...
                                		                            echo "<td style='width:90%'><a href='https://www.kud.ac.in/admin_panel/dept/qstd/". $row['fname']."' style='color:blue' target='_blank'>". $row['fname'] ."</a></td>";
                                								    echo "</tr>";
                                                                }
                                                            ?>
                                                        </table>
