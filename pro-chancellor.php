<?php
    ...
    $qry="select * from adm_page where design like 'Pro Chancellor'";
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
                ...
                <a href="pro-chancellor.php" class="active">Pro - Chancellor</a>
...
<section class="sectione2">
  <div class="container">
	...
	<div id="home" class="container tab-pane active"><br>
        <h3 style="font-family:Domine; font-weight:600;font-family:Trirong;text-align:center">Pro Chancellor</h3>
            <div class="row">
           ...
           <div class="col-lg-12">
                <div class="contains shadow-sm">
                  ...
                  <div class="administration">
                    ...
                    <center><h3 style="height:50px;font-family:'Enriqueta';background-color:#e1ebea;font-size:100%;padding:8px;border-right:5px solid #BB6464;border-left:5px solid #BB6464 ;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:80%"><strong><?php echo $nm; ?></strong></h3>
                         <p style="font-family:Average;font-size:18px;width:90%;text-align:center">
                        <?php echo $dsc;
                             if($ph!="")
                            {
                        ?><br>
                        ...
                        <?php 
                            ...
                            <?}else{?>
                                <button class="btn2 view_btn"><a href='file_upload/adm/<? echo $prf; ?>' target="blank">More Details</a></button>
                            <?}
