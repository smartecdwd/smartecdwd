			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-3 p-md-3 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
			        <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="good_gov_add.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-2 form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000;">Good Governance Initiatives Title</label>
                                    </div>
                                    <div class="col-sm-10 form-group">
                                        <input type="text" class="form-control" name="nm" style="font-size:14px;" maxlength="150">
                                    </div>    
                                </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $qry="insert into good_gov (gname,gdesc,gstatus) values ('$nm','$ndes','$nst')";
        echo $qry;
        $res=mysqli_query($conn,$qry);
        
        $qry="select max(ggid) as ggid from good_gov";
        $res=mysqli_query($conn,$qry);
