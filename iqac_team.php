...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/mytable1.css">	
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">Internal Access Quality Cell - Objectives</h1>
          </div>
        </div>
      </div>
    </section>
				...
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
					        <tr style="text-align:center;color:#fff; background-color:#1eaaf1">
					            <th style="">Options</th>
					            <th>Add</th>
					            <th>View</th>
					            <th>Edit</th>
                            ...
                            <tr style="text-align:center">
                                <!--<td style="text-align:left;color:#3229DE;font-weight:bold">IQAC PEOPLE --- 
                                <?php //echo $row['status']; ?></td>
                                <td><a href="iqac_team_view.php?qid=<?php //echo $ad; ?>"><img src="images/v2.jpg"> </a></td>
                                <td><a href="iqac_team_edit.php?qid=<?php //echo $ad; ?>"><img src="images/ed4.png" style="width:25%"></a></td>
                                <td><a href="iqac_team_del.php?qid=<?php //echo $ad; ?>"><img src="images/del3.png" ></a></td>-->
						    </tr>
						   <?php //}
						   ?>
						    <tr style="text-align:center">
                                <td style="text-align:left;color:#3229DE;font-weight:bold">IQAC PEOPLE --- Current</td>
                                <td><a href="iqac_team_cur.php?"><img src="images/add1.png"> </a></td>
                                <td><a href="iqac_team_cur_view.php"><img src="images/v2.jpg"> </a></td>
                                <td></td>
                                <td></td>
						    </tr>
						    <tr style="text-align:center">
                                <td style="text-align:left;color:#3229DE;font-weight:bold">IQAC PEOPLE --- Former</td>
                                <td><a href="iqac_team_add.php?"><img src="images/add1.png"> </a></td>
                                <td><a href="iqac_team_view.php?qid=former"><img src="images/v2.jpg"> </a></td>
                                <td><a href="iqac_team_edit.php?qid=former"><img src="images/ed4.png" style="width:25%"></a></td>
                                <td><a href="iqac_team_del.php?qid=former"><img src="images/del3.png" ></a></td>
						    </tr>
					    </table>
