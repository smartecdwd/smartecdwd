			...
			<div class="collapse navbar-collapse" id="mainNav">
					...
					<li class="nav-item px-3 dropdown">
						...
						<div class="dropdown-menu p-2" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="feedback-stake-holders.php?nid=Students">Feedback of Students</a>		
							<a class="dropdown-item" href="feedback-stake-holders.php?nid=Alumni">Feedback of Alumni</a>		
							<a class="dropdown-item" href="feedback-stake-holders.php?nid=Parents">Feedback of Parents</a>
							<a class="dropdown-item" href="feedback-stake-holders.php?nid=Students">Analysis & Action Taken</a>		
						</div>
					</li>
					...
					<li class="nav-item px-3 dropdown">
						...
						<div class="dropdown-menu p-2" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="iqac-annual-reports.php?nid=Annual">IQAC Annual Reports</a>		
							<a class="dropdown-item" href="iqac-annual-reports.php?nid=KU">Karnatak University Annual Reports</a>	
							<a class="dropdown-item" href="iqac-annual-reports.php?nid=SSR">SSR</a>
							<a class="dropdown-item" href="iqac-annual-reports.php?nid=NAAC">NAAC Reports</a>
						</div>
					</li>
