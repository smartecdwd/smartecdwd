           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="the-finance-committee.php" class="active">The Finance Committee</a>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div id="home" class="container tab-pane active">
        <h3 style="font-family:Trirong; font-weight:600;color:#000;text-align:center">Finance Committee Members</h3>
            ...
            <div class="row">
                <table style="width:100%;color:#000" id="customers">
                        ...
                        <?php
                            $qry="select * from adm_mem where design like 'Finance Committee' order by vord";
