                            ...
                            <div class="tab-content clearfix">
                                <div id="home" class="container tab-pane active"><br>
                                    <div class="row">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class='sub-menu'><a href='#'>About<div class='fa fa-caret-down right'></div></a>
                                                        			<ul>
                                            							 ...
                                            							 <li><a href="rank-holders.php?nid=<?php echo $_SESSION['branch']; ?>" class="active">Rank Holders</a></li>
                                        ...
                                        <div class="col-sm-9">
                                            <h5 class="my-3">RANK HOLDERS</h5>
                                                <?php
                                                    $qry="select * from vw_dep_rank where did=".$nid."";
                                                    $res=mysqli_query($conn,$qry);
                                                    $cnt=1;
                                                    $fid="";
                                                    while($row=mysqli_fetch_assoc($res))
                    							...
                    							?>
                                                <table class="table table-bordered my-3" style="width:100%;background-color:#eee">
                                                    <?php
                                                        $qry="select * from vw_dep_file where did=".$nid."";
                                                        $res=mysqli_query($conn,$qry);
                                                        while($row=mysqli_fetch_assoc($res))
