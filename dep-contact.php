...
<style>
    h5{font-family:Alice;color:#0074B7;text-align:center;font-size:20px;font-weight:bold;}
	 p{font-family:Signika;text-align:left;font-size:16px}
</style>
    ...
    <div class="row border_around p-3 text-justify">
      <div class="col-lg-12">
                        <?php
                               ...
                               <h2 class="title_head" style="font-family:Domine; font-weight:600; padding-top:30px;"><?php echo $row['dname']; ?> &nbsp;<i class="fa fa-caret-right"></i> Contact</h2>
                              <?php 
		                        }
        ...
        <div id="home" class="container tab-pane active"><br>
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <h5>CONTACT</h5>
                    <br>
                    <p style="font-size:20px;font-weight:bold">The Chairperson</p>
                     <?php
                                //$nid=$_REQUEST['nid'];
                                $qry="select * from vw_dep_con where did=".$nid ; // and _type='JRF'";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
							...
							?>
                             ...
                             <!--   <table class="table table-bordered " style="width:100%;background-color:#eee">
								...
								<th style="width:97%">Files</th>
								
								</tr>-->
                            <?php
                              /*  $qry="select * from dep_alm_file where dalid=".$fid."";
                                $res=mysqli_query($conn,$qry);
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr>";
								    echo "<td style='text-align:center; width:8%;'>".$cnt++."</td>";
		                            echo "<td style='width:97%'><a href='https://smartechd.online/kud/admin_panel/dept/qstd/". $row['fname']."' style='color:blue' target='_blank'>". $row['fname'] ."</a></td>";
								    echo "</tr>";
                                }*/
                            ?>
                                </table>
