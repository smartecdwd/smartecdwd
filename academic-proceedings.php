<?php
    ...
    $qry="select Distinct(year(pdate)) as pd from aca_pro order by pd";
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               ...
               <a href="chancellor.php">Chancellor</a>
				...
				<a href="academic-proceedings.php">The Academic Proceedings</a>
  ...
  <div class="container">
    ...
    <div class="tab-content">
      <div id="home" class="container tab-pane active">
        <h3 style="font-family:Domine; font-weight:600;text-align:center">Academic Council Proceedings</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        ?>
                            ...
                            <?php
                                                $qry="select * from aca_pro where year(pdate)=".$yr[$i]. " order by pdate";
                                                $res=mysqli_query($conn,$qry);
                                                $cnt=1;
                                                while($row=mysqli_fetch_array($res))
                                                {
                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="https://www.kud.ac.in/admin_panel/admin/file_upload/aca_pro/<? echo $row['fname'];?>" target="_blank"><? echo $row['details']; ?></a></td>
