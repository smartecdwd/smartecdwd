           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="application-entry-for-colleges.php" class="active">Applications Entry For Colleges</a>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        ...
        <table id="customers" style="width:80%" align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align:center">Applications Entry For Colleges</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td > 
                           <a href="https://kudugcollegeentry.aargeessoftware.com/" target="_blank"> Application Entry For Colleges 1</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td > 
                           <a href="https://kudapplication.aargeessoftware.com/" target="_blank"> Exam Application download for PG</a>
                        </td>
					 ...
					 <tr>
                        ...
                        <td > 
                           <a href="https://kudapplicationbed.aargeessoftware.com/" target="_blank"> B.Ed. Application Download</a>
                        </td>
                    </tr>
					 <tr>
                        <td style="text-align:center" width="10%">11</td>
                        <td > 
                           <a href="https://kudapplicationentrybed.aargeessoftware.com/" target="_blank"> B.Ed. Application Entry</a>
                        </td>
                    </tr>
					 <tr>
                        <td style="text-align:center" width="10%">12</td>
                        <td> 
                            <a href="http://kudrevalapplication.aargeessoftware.com/default.aspx" target="_blank">RV Application Download</a>
                        </td>
                    </tr>
					 <tr>
                        <td style="text-align:center" width="10%">13</td>
                        <td > 
                           <a href="http://kudrevalapplicationpg.aargeessoftware.com/" target="_blank">RV Application Download Bed. BPEd</a>
                        </td>
                    </tr>
