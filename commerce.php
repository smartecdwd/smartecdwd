      ...
      <div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Commerce</li>
          </ol>
        </nav>
      </div>
    </div>
	  ...
	  <h5 style="text-align:center; padding-top:20px; "><b>DEPARTMENTS</b></h5>
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
				...
				<a href="commerce.php" class="active" style="background-color:#6495ED">Commerce</a>
...
<h2 style="font-family:Domine; font-weight:600; text-align:center;font-size:26px"> Faculty of Commerce</h2>
		...
		<?php
				...
				$qry="select * from vw_dep_file where branch='Commerce' order by dname";
