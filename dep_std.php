      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php echo $_SESSION['branch']; ?> - Student Details</h1>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="col-12">
                        <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            ...
                            <?php
                                ...
                                echo "<tr><td></td><td>".$row['dname']."</td>";
                                echo "<td style='text-align:center'><a href='dep_std_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td><td></td><td></td></tr>";
                            
                                $qry="select distinct ac_yr from vw_std where branch ='" . $_SESSION['branch']."' order by dname";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td style='text-align:center'><a href='dep_std_view.php?did=".$row['ac_yr']." '><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='dep_std_edit.php?did=".$row['ac_yr']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                    echo "<td style='text-align:center'><a href='dep_std_del.php?did=".$row['ac_yr']."&dp=".$row['ac_yr']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                }
                            ?>
                        </table>
                    </div>
