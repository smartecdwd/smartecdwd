...
<section class="section1">
  <div class="container">
      <h2 class="title_head" style="font-family:Trirong;text-align:center;color:#000">Policies and Guidelines</h2>
      <br>
 ...
 <div id="menu6" class="tab-pane"><br>
                        ...
                        <div class="col-12 mb-sm-3">
                          ...
                          <table class="table table-striped" id="customers" align="center" style="width:80%;font-family:exo">
                            <tr>
                                ...
                                <th style="width:90%;border:1px solid #eee">&nbsp;&nbsp;Policies and Guidelines</th>
			  ...
			  <?php
                                ...
                                while($row=mysqli_fetch_assoc($res))
                                {
									...
									echo  "<td style='border:1px solid #eee'><a href='https://www.kud.ac.in/admin_panel/iqac/pol/". $row['fname']."' target='blank'>". $ft[0] ."</a></td>";
									 echo "</tr>";
