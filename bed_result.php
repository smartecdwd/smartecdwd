                        ...
                        <div class="row">
                            <div class="col-sm-10 mx-auto">
                                <?php
                                    ...
                                    if($cnt==0)
                                    {
                                      // echo "<script>window.location.href='bed_result_m.php?msg=true';</script>";
                                    }
        							?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color:#fff"><strong><?php echo $term;?></strong></td>
                                    </tr>
                                </table>
                                </div>
                                <br><br>
