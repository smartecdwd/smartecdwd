...
error_reporting(0);
include 'db_con.php';
$qry="select * from adm_page where design like 'Registrar'";
...
<section class="sectione2">
  <div class="container">
    ...
    <div class="tab-content">
      ...
      <h3 style="font-family:Trirong;color:#000; font-weight:600;text-align:center">Registrar</h3>
            <div class="row">
