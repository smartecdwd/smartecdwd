...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Advisory</title>
    <meta charset="utf-8">
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_fdbk_add.php" method="post" enctype="multipart/form-data">
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="insert into iq_fdbk (fb_det,fdbk) values('$dbj','$st')";
        $res=mysqli_query($conn,$qry);
        $qry="select max(iq_fbid) as fid from iq_fdbk";
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_fdbk_file (iq_fbid,fname) values(".$row['fid'].",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
