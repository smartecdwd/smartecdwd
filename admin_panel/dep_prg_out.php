...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Program Out Come</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php echo $_SESSION['branch']; ?> - Programme Specific OutComes</h1>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="col-12">
                        <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            ...
                            <?php
                                ...
                                $qry="select * from vw_dep_prg_out where did ='" . $_REQUEST['did']."' order by dname";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td style='text-align:center'><a href='dep_out_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                    echo "<td style='text-align:center'><a href='dep_out_view.php?did=".$row['doid']." '><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='dep_out_edit.php?did=".$row['doid']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                    echo "<td style='text-align:center'><a href='dep_out_del.php?did=".$row['doid']."&dp=".$row['did']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                }
                            ?>
                        </table>
                    </div>
