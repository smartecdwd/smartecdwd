...
<html lang="en">
 ...
 <script type="text/javascript">
     ...
     <script>
        function pg_bk()
        {
            window.location.href="dept_view.php";
        }
    </script>
  </head>
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px"><?php echo $_SESSION['dname'];?> - Overview</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_insert.php" method="post" enctype="multipart/form-data">
                                   <!--<div class="form-group">
                                   	    <label class="label" for="name" style="font-size:14px;color:#000">Select Branch</label>
            							<select type="text" name="br" id="br" class="form-control" style="font-size:14px">
            							    <option>Arts</option>
                                   	...
                                   	<div class="form-group">
            							...
            							<input type="text" name="dn" id="dn" class="form-control" style="font-size:14px" required value='<?php echo $_SESSION['dname']; ?>' readonly>
						            </div>
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Department Objective</label>
