<?php
    ...
    $qry="select * from vw_dep_fp where did=".$did;
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:16px;padding:7px"><?php echo $_SESSION['dname']; ?> - Future Plan</h1>
          </div>
        </div>
      </div>
    </section>
