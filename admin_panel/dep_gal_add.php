...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Gallery</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION['dname'];?> - Best Practice</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_gal_add.php" method="post" enctype="multipart/form-data">
						            ...
						            <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label class="label" for="name" style="font-size:15px;color:#000;">File Upload</label>
                                            <input type="file" name="f1[]" class="form-control" style="font-size:14px">
    						            </div>
    						            <div class="col-sm-6 form-group">
                                            <label class="label" for="name" style="font-size:15px;color:#000;">Description</label>
                                            <input type="text" name="d1[]" class="form-control" style="font-size:14px">
                                        </div>
						            </div>
						           <div class="row">
                                        <div class="col-sm-6 form-group">
    ...
    if(isset($_POST['submit']))
    {
        ...
        for($i=0;$i<9;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $image = $_FILES['f1']['tmp_name'][$i]; 
                $imgContent = addslashes(file_get_contents($image)); 
                $qry="insert into dep_gal (did,descp,dpic) values($dd,'$des','$imgContent')";
                $res=mysqli_query($conn,$qry);
                //echo $imgContent;
            }
        }
