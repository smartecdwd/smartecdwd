...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Infrastructure</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:17px;padding:7px"><?php echo $_SESSION['dname']; ?> - Infrastructure</h1>
          </div>
        </div>
      </div>
    </section>
