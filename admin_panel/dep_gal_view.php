      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $dn; ?> - How to Apply</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_app_view.php" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                   	            $qry="select * from dep_gal where did=".$did;
                                                ...
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                echo "<tr>
                                   	                    <td>";?>
                                   	                     <img class="example-image" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['dpic']); ?>" style="width:150px">
                                   	                <? echo "</td>
                                   	                    <td style='color:#1f75fe;valign:middle'>".$row['descp']."</td> 
                                   	                    <td><a href='dep_gal_del.php?fid=".$row['gid']."'> <img src='images/x2.png' style='padding:10px;width:40px'></a> </td>
		</tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
