			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-3 p-md-3 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
			        <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="noti_add.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-2 form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000;">Notification Name</label>
                                    </div>
                                    <div class="col-sm-10 form-group">
                                        <input type="text" class="form-control" name="nm" style="font-size:14px;" minlength="15" required>
                                    </div>    
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input  type="date" class="form-control" data-date="" data-date-format="d-M-Y"  style="font-size:14px;width:50%" required name='nd'>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 form-group ">
                                        <select class="form-control" name="typ" id="typ"  style="font-size:14px" required>
                                ...
                                <div class="row">
                                    <div class="col-sm-10 form-group ">
                                        <label class="label" for="name" style="font-size:15px;color:#000;"><b>Notification Upload</b></label>
                                    </div>
                                </div>
                                <div class="row">
