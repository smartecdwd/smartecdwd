  ...
  <head>
   ...
   <script>
    ...
    <style>
        ...
        h4{font-family:Enriqueta;text-align:center;font-size:16px}
    </style>
  </head>
  <body>
	  <div class="py-2">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION['dname']; ?></h1>
          </div>
        </div>
      </div>
    </section>
