<?php
    ...
    $qry="select * from adm_mem where design like '%$dg%' order by vord";
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                <table class="table table-bordered" style="width:100%;color:#000;border:1px solid #000" align="center">
                                        <tr>
                                            ...
                                            <th style="width:70%">List of <?php echo $dg;?> Members</th>
                                        ...
                                        while($row=mysqli_fetch_array($res))
                                        {
                                            ...
                                            echo "<td>".$row['name']."<br>".                                          
                                                ...
                                                $row['phone']."<br>".
                                                $row['email']."</td>
                                                <td style='text-align:center'><a href='sy_edit.php?did=ac&sl=".$row['slno']."'><img src='https://kud.ac.in/admin_panel/images/ed4.png' style='width:20px'></a></td>
                                <td style='text-align:center'><a href='sy_del.php?did=ac&sl=".$row['slno']."'><img src='https://kud.ac.in/admin_panel/images/del3.png' style='width:20px'></a></td>
                                            </tr>";
