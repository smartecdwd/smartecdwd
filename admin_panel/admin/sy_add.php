			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="sy_add.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="label" for="name" style="color:#000;font-size:14px">Name</label>
							        <input type="text" name="nm" class="form-control" style="color:#000;font-size:14px">
						        </div>
						        <div class="form-group">
							        <label class="label" for="name" style="color:#000;font-size:14px">Details</label>
							        <textarea rows="4" name="dt" class="form-control" style="color:#000;font-size:14px;"></textarea>
						        </div>
						         <div class="form-group">
						        ...
						        <div class="form-group">
							        ...
							        <input type="email" name="em" class="form-control" style="color:#000;font-size:14px;">
						        </div>
                                <div class="form-group">
							        <label class="label" for="name" style="color:#000;font-size:14px">Display Order</label>
							        <input type="number" name="vo" class="form-control" style="color:#000;font-size:14px;width:100px" required>
						        </div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $cd=trim(str_replace("'",'-', $_REQUEST['dt']));
        $ph=trim($_REQUEST['ph']);
        $em=trim($_REQUEST['em']);
        $vo=trim($_REQUEST['vo']);
        /*$imgContent="";
        ...
        $qry="insert into adm_mem (name,details,phone,email,design,vord) values('$cn','$cd','$ph','$em','$dg','$vo')";
