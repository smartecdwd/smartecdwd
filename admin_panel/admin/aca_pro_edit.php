<?php
    ...
    $qry="select * from aca_pro where slno=".$sl;
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="aca_pro_edit.php" method="post" enctype="multipart/form-data">
						        ...
						        <div class="form-group">
							        ...
							        <input type="date" name="dt" class="form-control" style="color:#000;font-size:14px;width:250px" value='<?echo date('d-m-Y',strtotime($dt));?>'>
						        ...
						        <div class="form-group">
						            <label class="label" for="name" style="color:#000;font-size:14px">File Uploaded </label>
							        <a href="file_upload/aca_pro/<?echo $fn;?>"><?echo $fn;?></a>
						        </div>
						        <div class="form-group">
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update aca_pro set details='$cn',pdate='$dt',vord='$vo' where slno=$sl";
        $res=mysqli_query($conn,$qry);
        echo $qry;
        if(($_FILES['f1']['size']>0 ) && ($_FILES['f1']['type']=="application/pdf"))
        {
            ...
            $qry="update aca_pro set fname='$file' where slno=".$sl;
            $res=mysqli_query($conn,$qry);
        }
	    unset($_POST['submit']);    
