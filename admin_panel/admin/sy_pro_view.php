<?php
    ...
    $qry="select * from adm_pro order by pdate";
                                ...
                                <table class="table table-bordered" style="width:100%;color:#000;border:1px solid #000" align="center">
                                        ...
                                        while($row=mysqli_fetch_array($res))
                                        {
                                            ...
                                            echo "<td>".$row['pdate']."</td>
                                                <td style='text-align:center'><a href='sy_pro_edit.php?sl=".$row['slno']."'><img src='https://kud.ac.in/admin_panel/images/ed4.png' style='width:20px'></a></td>
                                <td style='text-align:center'><a href='sy_pro_del.php?sl=".$row['slno']."'><img src='https://kud.ac.in/admin_panel/images/del3.png' style='width:20px'></a></td>
                                            </tr>";
