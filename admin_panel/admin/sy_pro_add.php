			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="sy_pro_add.php" method="post" enctype="multipart/form-data">
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        {
            $qry="insert into adm_pro(details,pdate,vord) values('$cn','$dt','$vo')";
            $res=mysqli_query($conn,$qry);
        
            $qry="select max(slno) as slno from adm_pro";
            $res=mysqli_query($conn,$qry);
            ...
            $qry="update adm_pro set fname='$file' where slno=".$row['slno'];
            $res=mysqli_query($conn,$qry);
        }
	    unset($_POST['submit']);    
