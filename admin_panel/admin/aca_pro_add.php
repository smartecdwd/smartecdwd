			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="aca_pro_add.php" method="post" enctype="multipart/form-data">
						        ...
						        <div class="form-group">
							        ...
							        <input type="date" name="dt" class="form-control" style="color:#000;font-size:14px;width:250px">
						        </div>
                                <div class="form-group">
							        <label class="label" for="name" style="color:#000;font-size:14px">Display Order</label>
							        <input type="number" name="vo" class="form-control" style="color:#000;font-size:14px;width:100px" >
						        </div>
						        <div class="form-group">
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        {
            $qry="insert into aca_pro(details,pdate,vord,pyear) values('$cn','$dt','$vo','$yr')";
            $res=mysqli_query($conn,$qry);
        
            $qry="select max(slno) as slno from aca_pro";
            $res=mysqli_query($conn,$qry);
            $row=mysqli_fetch_array($res);
            
            $temp='file_upload/aca_pro/';
            $file = $_FILES['f1']['name'];
            ...
            $qry="update aca_pro set fname='$file' where slno=".$row['slno'];
            $res=mysqli_query($conn,$qry);
        }
	    unset($_POST['submit']);    
