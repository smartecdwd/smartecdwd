  ...
  <head>
    ...
    <link rel="stylesheet" href="css/htab.css">	
     <script>
	    function add_rec()
	    {
	        window.location.href='fac_add.php';
	    }
	</script>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?echo $_SESSION['branch'];?> - Faculty</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
					        ...
					        <?php
                                //$qry="select * from vw_fac_dep where branch='". $_SESSION['branch']."' order by dname";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td style='text-align:center'><a href='faculty.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_view.php?did=".$row['did']."'><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_edit.php?did=".$row['did']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_del.php?did=".$row['did']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                }
                            ?>
					    </table>
				...
				<div class="col-md-3 d-flex align-items-stretch" style="width:100%;height:700px">
