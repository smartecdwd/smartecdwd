      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">Annoucement</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
                ...
                <form action="announce_upd.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-2">
                   	    ...
                   	    <div class="col-sm-10 form-group">
                            <input type="file" class="form-control" name="f1"  style="font-size:14px">
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <?php 
                                ...
                                ?>
                                    <li>
                                        ...
                                        <a href="<?echo $alk;?>" target="_blank"><?echo $row['ftitle'];?></a>
                                        <a href='announce_file.php?fid=<?$row['afid'] ; ?>'><img src="https://kud.ac.in/admin_panel/images/x2.png" style="padding:10px;float:right"></a>
                                    </li>
                            <?php } ?>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-7">
                            <input type="text" name="lk" class="form-control" style="font-size:14px" value="<?echo $lk;?>">
                        </div>
		            </div>
		            <div class="row">
                        <div class="form-group col-sm-2">
                    ...
                    <div class="row">
                    	<div class="col-sm-12 form-group">
							<center><input type="submit" value="Submit" class="btn btn-primary py-3 px-5"></center>
						</div>
