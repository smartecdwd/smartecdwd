  ...
  <head>
    ...
    <script src="https://cdn.datatables.net/1.10.18/js/dataTables.bootstrap4.min.js"></script>
     ...
     <script>
	    function add_ann()
	    {
	        window.location.href='announce_add.php';
	    }
	</script>
  </head>
  <body>
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
			    ...
			    <div class="col-12">
                    <button id="btnAdd" type="button" class="btn btn-success" onclick="add_ann()">Add New Record</button>
                    
                </div>
                        
				<div class="container">
				    <br><br>
				    <form method="post" action="announce_del.php">
                    ...
                    <table class="table table-bordered table-responsive" id="dataTable" width="100%" cellspacing="0" style="font-size:10pt">    
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="width:50%;font-size:9pt">Announcement </th>
                                <th style="font-size:9pt;width:10%">Announced On </th>
                        ...
                        <tbody>
                            <?php
                                $qry="select * from announce order by adate desc";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td>".$row['adata']."</td>";
                                    echo "<td style='text-align:center'>".date('d-M-Y',strtotime($row['adate']))."</td>";
                                    echo "<td style='text-align:center'>".$row['status']."</td>";
                                    echo "<td style='text-align:center'><a href='announce_view.php?aid=".$row['aid']."' ><img src='https://kud.ac.in/admin_panel/images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='announce_edit.php?aid=".$row['aid']."'><img src='https://kud.ac.in/admin_panel/images/ed4.png' style='width:20px'> </a></td>";?>
                                    <td style='text-align:center'>
                                            <input class='form-check-input' type='checkbox' name='ids[]' value='<?php echo $row['aid']; ?>'>  </td>
                                <?php
                                    echo "</tr>";        
