                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
					        <?php
                                ...
                                {
                                    echo "<tr><td colspan='3'><img src='data:image/jpg;charset=utf8;base64,". base64_encode($row['pimg'])."' alt='No Picture' style='width:150px'/></td>";
                                    echo "<tr><td style='align:center;font-weight:bold'>". $row['fname']."
                                            <a href='iqac_team_cur_edit.php?fid=".$row['iq_cid']."' style='float:right;'>Edit</a>
                                    </td><td style='align:center;font-weight:bold;'>
                                            <a href='iqac_team_cur_del.php?fid=".$row['iq_cid']."' style='float:right;color:red'>Delete</a>
                                    </td>
                                    </tr><tr><td>&nbsp;</td></tr>";
                                }
                            ?>
