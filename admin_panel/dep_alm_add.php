...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Alumni</title>
    <meta charset="utf-8">
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_alm_add.php" method="post" enctype="multipart/form-data">
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="insert into dep_alm (did,al_det) values('$dn','$dbj')";
        $res=mysqli_query($conn,$qry);
