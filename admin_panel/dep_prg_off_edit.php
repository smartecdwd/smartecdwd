<?php
    ...
    $qry="select * from vw_dep_prg where did=".$did;
...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Programme Offered</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $dn; ?> - Programmes Offered</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="dep_prg_off_edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Course Offered</label>
						            ...
						            <div class="row">
                                        <div class="col-md-8 form-group">
    						                 ...
    						                 <?php
    						                    $qry="select * from dep_prg_files where dpid=".$fid;
    						                    $res=mysqli_query($conn,$qry);
    						                    while($row=mysqli_fetch_array($res))
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='dep_prg_file.php?fid=<?php echo $row['dpfid'];?>&dd=<?php echo $did;?>'>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update dep_prg_off set prgm='$dbj' where dpid=".$df;
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into dep_prg_files (dpid,fname) values(".$dd.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
