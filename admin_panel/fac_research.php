...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Research</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?echo $_SESSION['branch'];?> - Research</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
					        ...
					        <?php
                                $qry="select * from vw_fac_rea where branch='". $_SESSION['branch']."' order by dname";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td>".$row['rea_typ']."</td>";
                                    echo "<td style='text-align:center'><a href='fac_rea_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_rea_view.php?did=".$row['frid']."'><img src='images/v2.jpg'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_rea_edit.php?did=".$row['frid']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                    echo "<td style='text-align:center'><a href='fac_rea_del.php?did=".$row['frid']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                }
                            ?>
					    </table>
				...
				<div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate" style="height:500px">
					        <br>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $amt=$_REQUEST['amt'];
        $st=$_REQUEST['rst'];
        $qry="insert into fac_research (fid,rtitle,fund_agency,co_inves,amt,rstatus) values ('$fd','$trt','$fa','$co','$amt','$st')";
        $res=mysqli_query($conn,$qry);
       
        echo"<script>window.location.href='fac_research.php';</script>";
    }
?>