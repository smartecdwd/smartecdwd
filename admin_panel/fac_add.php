	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="fac.php" class="nav-link" style="font-size:20px">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php echo $_SESSION['branch']; ?> - Faculty</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					     <form action="fac_add.php" method="post" enctype="multipart/form-data">
				        ...
				        <!--<div class="form-group">
				             <label class="label" for="name" style="font-size:14px;color:#000">Faculty List</label>
				             <input class="form-control" name="dn" id="dn" style="font-size:14px" required>
				        </div>-->
                        <div class="form-group">
                            <label class="label" for="name" style="font-size:14px;color:#000">Faculty List</label>
			            ...
			            <div class="form-group">
			           	...
			           	<div class="form-group" style="padding-top:20px;text-align:center">
				            <center><button class="btn btn-danger py-3 px-5"><a href='dep_fac.php' style='color:#fff'>Cancel</a></button>
				            <input type="submit" name="submit" value="Submit" class="btn btn-primary py-3 px-5"></center>
			            </div>
			            <input type="text" name="tdd" value='<?php echo $_REQUEST['did']; ?>' style='visibility:hidden'>
                   </form>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="insert into fac_mas (did,fdet) values('$dd','$dbj')";
        $res=mysqli_query($conn,$qry);
        $qry="select max(fid) as fid from fac_mas";
        $res=mysqli_query($conn,$qry);
        $row=mysqli_fetch_array($res);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into fac_files (fid,fname) values(".$row['fid'].",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
        echo "<script>window.location.href='fac.php';</script>";
    }
?>
