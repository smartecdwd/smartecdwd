	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="chk_out.php" class="nav-link" style="font-size:20px">Logout</a></li>
				</ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
		...
		<section class="ftco-section">
				...
				<div class="row">					
					<div class="col-lg-4 sidebar ftco-animate">            
						<div class="sidebar-box ftco-animate">							
							<ul class="categories">
								<li><a href="dept_home.php" style="color:#2E4C6D">Department</a> </li>
								<li><a href="fac.php" style="color:#2E4C6D">Faculty </a></li>
								<li><a href="proj.php" style="color:#2E4C6D">Projects</a></li>
								<li><a href="resea.php" style="color:#2E4C6D">Research</a></li>
								<li><a href="feedbk_stake.html" style="color:#2E4C6D">Feedback of Stake Holders </a></li>
								<li><a href="iqac_rep.php" style="color:#2E4C6D">IQAC Reports </a></li>								
								<li><a href="iqac_pol.php" style="color:#2E4C6D">Policies and Guidelines</a></li>
								<li><a href="iqac_an_rep.php" style="color:#2E4C6D">IQAC Annnual Reports</a></li>								
								<li><a href="iqac_nirf.php" style="color:#2E4C6D">NIRF</a></li>
								<li><a href="iqac_prg_out.php" style="color:#2E4C6D">Programme Outcomes</a></li>
								<li><a href="#" style="color:#2E4C6D">Best Practices</a></li>
          ...
          <div class="col-lg-7 ftco-animate">
              <img src="images/dep1.jpg" alt=""  class="img-fluid">         
          </div> <!-- .col-md-8 -->
