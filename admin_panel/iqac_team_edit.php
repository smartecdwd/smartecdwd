<?php
    ...
    $qry="select * from iq_team";// where iq_tid=".$did;
...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - People</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_team.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px">IQAC - About</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="iqac_team_edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000;font-weight:bold">About IQAC</label>
                                        <textarea id="text_editor"  name="text_editor"><?php echo $dj; ?></textarea>
						        </div>
						        <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Team Status</label>
                                        <select class="form-control" style="font-size:14px" name="st">
                                            <?php 
                                            if($st=="Current")
                                            ...
                                            if($st=="Former")
                                                echo "<option selected>Former</option>";
                                            else
                                                echo "<option>Former</option>";
                                                ?>
                                        </select>
                                    </div>
						        <div class="row">
						            <!--    <div class="col-md-8 form-group">
    						                 <label class="label" for="name" style="font-size:14px;color:#000font-weight:bold">File Uploaded</label><br>
    						                 <table style="color:#334BFF;width:100%">-->
    						                    ...
    						                    <!--   <tr>
    						                           ...
    						                           <td>
    						                               <a href='dep_app_file.php?fid=<?php //echo $row['dal_fid'];?>&dd=<?//php echo $did;?>'>
    						    ...
    						    <div class="form-group" style="padding-top:20px;text-align:center">
						            <center><button class="btn btn-danger py-3 px-5"><a href='iqac_team.php' style='color:#fff'>Cancel</a></button>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update iq_team set tm_iqc='$dbj',status='$st' where iq_tid=".$dn;
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_team_file (iq_tid,fname) values(".$dn.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
       ...
       // echo $qry;
        echo "<script>window.location.href='iqac_team.php';</script>";
    }
?>