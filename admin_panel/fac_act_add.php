      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION['dname']; ?> - Activities</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					     <form action="fac_act_add.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="label" for="name" style="font-size:14px;color:#000">Activities List</label>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $dd=trim($_REQUEST['tdd']);
        $par=trim($_REQUEST['par']);
        $dbj=trim($_REQUEST['text_editor']);
        //$aty=$_REQUEST['atyp'];
       
        
        $qry="insert into fac_act (did,adet,act_type) values('$dd','$dbj','$par')";
        $res=mysqli_query($conn,$qry);
        //echo $qry;
        $qry="select max(faid) as fid from fac_act";
        $res=mysqli_query($conn,$qry);
        $row=mysqli_fetch_array($res);
