<?php
    ...
    $qry="select * from vw_dep_fac where did=".$did;
...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Facilities</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px"><?php echo $_SESSION['dname'];?> - Facility</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_fac_edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Department Facilties</label>
    						                 ...
    						                 <?php
    						                    ...
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='dep_fac_file.php?fid=<?php echo $row['dffid'];?>&dd=<?php echo $did;?>'>
    						        ...
    						        <div class="row">
						              ...
						              <input type="text" name="df" value='<?php echo $dd1; ?>' style='visibility:hidden'>
						          </div>
                               </form>
                            </div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update dep_faci set faci='$dbj' where dfid=".$df;
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into dep_faci_files (dfid,fname) values(".$dd.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
       //echo "<script>window.location.href='dep_fac.php?did=$dd1';</script>";
