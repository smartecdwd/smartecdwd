...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Reports</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_rep.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Reports</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_rep_add.php" method="post" enctype="multipart/form-data">
                                   <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Files Type</label>
                                            <select name="typ" class="form-control" style="font-size:14px">
						            ...
						            <div class="form-group">
						             ...
						             <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_rep.php" style='color:#fff'>Cancel</a></button>
...
<?php
    if(isset($_POST['submit']))
    {
       ...
       $qry="insert into iq_rep (rep_type) values('$dbj')";
        $res=mysqli_query($conn,$qry);
        $qry="select max(iq_rid) as fid from iq_rep";
        $res=mysqli_query($conn,$qry);
        ...
        if ($dbj=="General")
            ...
            $fld='iqac/reports/aaac/';
        else if ($dbj=="Annual")
            $fld='iqac/reports/annual/';
        else if ($dbj=="University")
            $fld='iqac/reports/uni/';
        else if ($dbj=="NAAC")
            $fld='iqac/reports/naac/';
        else if ($dbj=="SSR")
            $fld='iqac/reports/ssr/';
        ...
        for($i=0;$i<8;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_rep_file (iq_rid,fname) values(".$row['fid'].",'".$file."')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
        echo "<script>window.location.href='iqac_rep.php';</script>";
    }
?>