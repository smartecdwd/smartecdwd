...
<html lang="en">
  <head>
    <title>Karnatak University | Department - LMS</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="dep_lms.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
                                ...
                                if(isset($_SESSION['branch']))
                                {
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                    {
                                       ...
                                       echo "<td style='text-align:center'>".$cnt++."</td>";
                                        ...
                                        echo "<td style='text-align:center'><a href='dep_lms_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_lms_view.php?did=".$row['did']."&dp='dpt'><img src='images/v2.jpg'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_lms_edit.php?did=".$row['did']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                        //echo "<td style='text-align:center'><a href='dep_abt_bp_del.php?did=".$row['did']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                    }
