...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Course Structur</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php echo $_SESSION['dname']; ?> - Course Structure</h1>
                                    ...
                                    <table class="table" style="width:100%;color:#000">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='dept/cou/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                   	</div>
