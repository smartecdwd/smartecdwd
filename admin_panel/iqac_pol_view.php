                               ...
                               <form action="#" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <tr>
                                   	            <td style="font-weight:bold;font-size:18px">IQAC - Policies & Guidelines</td>
                                   	        </tr>
                                   	        
                                   	    </table>
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                   	            $qry="select * from iq_pol_file order by fname "; // where iq_adid=".$fid;
    
                                                $res=mysqli_query($conn,$qry);
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='iqac/pol/". $row['fname']."' target='_blank'>".$row['fname']."</a>
    						                              </td><td><a href='iqac_nrif_del.php?fid=".$row['iq_oid']."'> <img src='images/x2.png' style='padding:10px'></a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
