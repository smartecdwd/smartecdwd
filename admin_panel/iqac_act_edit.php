	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_act.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Activities</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_edit_add.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">IQAC Activities </label>
						            ...
						            <div class="row">
    						            <div class="col-md-8 form-group">
    						                 ...
    						                 <?php
    						                    $qry="select * from iq_act_file order by iqac_fid";
    						                    $res=mysqli_query($conn,$qry);
    						                    while($row=mysqli_fetch_array($res))
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='iq_act_file.php?fid=<?php echo $row['iqac_fid'];?>&dd=<?php echo $did;?>'>
						            ...
						            <div class="form-group">
						             ...
						             <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_act.php" style='color:#fff'>Cancel</a></button>
                      ...
                      <div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate" style="background-color:#eee">
					        ...
					        <div class="vertical-menu" style="width:100%;font-family:exo">
								...
								<a href="iqac_act.php" class="active">Activities of IQAC</a>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        //$qry="insert into iq_act (act_det) values('$dbj')";
        //$res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<8;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into iq_act_file (iq_acid,fname) values(".$row['fid'].",'".$file."')";
                $res=mysqli_query($conn,$qry);
            }
        }
        
        echo "<script>window.location.href='iqac_act.php';</script>";
    }
?>