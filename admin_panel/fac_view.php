<?php
    ...
    //$qry="select * from vw_fac_dep where fid=".$did;
  ...
  <head>
    ...
    <script>
        function confirm_del(fid){
            ...
            if(conf)
                window.location.href='fac_del.php?fid='+ fid;
        }
    </script>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION['dname']; ?> - Faculty List</h1>
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                $res=mysqli_query($conn,$qry);
                                   	            while($row=mysqli_fetch_array($res))
                                                {
                                                    echo "<tr><td colspan='3'><img src='data:image/jpg;charset=utf8;base64,". base64_encode($row['pimg'])."' style='width:150px'/></td></tr>";
                                                    echo "<tr><td style='align:center;'>". $row['fname']."</td><td>
                                                            <a href='fac_edit.php?fid=".$row['fid']."' style='float:right;'><img src='images/ed4.png' style='width:80%'></a> 
                                                    </td>
                                                    <td>
                                                            <!--<a href='fac_del.php?fid=".$row['fid']."' style='float:right;'><img src='images/del3.png' style='width:80%'> </a>-->
                                                            <a href='#' onclick='return confirm_del(".$row["fid"].")' style='float:right;'><img src='images/del3.png' style='width:80%'> </a>
                                                    </tr>";
                                                }
                                                ...
                                                {
                                   	                echo "<tr>";
                                   	                echo "<td style='color:#1f75fe'><a href='fac/prof/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td></tr>";
                                   	            } */
                                   	        ?>
