<?php
    ...
    $qry="select * from vw_fac_ach where did=".$did . " and ah_type like '%".$par."%'";
...
<html lang="en">
  <head>
    <title>Karnatak University | Department - Achievements</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION['dname'];?> - Achievements List</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="fac_ach_edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Achievement List</label>
                                        <textarea id="text_editor" name="text_editor"><?php echo $dj; ?></textarea>
						            </div>
						            <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Achievement List</label>
                                        <select name="atype" class="form-control" style="font-size:14px">
                                            <?php
                                                if($ah=="")
                                                ...
                                                if($ah=="Awards")
                                                    echo "<option selected>Awards</option>";
                                                else
                                                    echo "<option>Awards</option>";
                                                if($ah=="Honors")
                                                    echo "<option selected>Honors</option>";
                                                else
                                                    echo "<option>Honors</option>";
                                                if($ah=="Achievements")    
                                                    echo "<option selected>Achievements</option>";
                                                else
                                                    echo "<option>Achievements</option>";
                                            ?>
                                        </select>
            			            </div>
						            <div class="row">
    						                 ...
    						                 <?php
    						                    ...
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='fac_ach_file.php?fid=<?php echo $row['fh_fid'];?>&dd=<?php echo $did;?>'>
    						        ...
    						        <div class="row">
						              ...
						              <input type="text" name="par" value='<?php echo $par; ?>' style='visibility:hidden'>
						          </div>
                               </form>
                            </div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update fac_ach set ah_det='$dbj' where fhid=".$dd;
        $res=mysqli_query($conn,$qry);
        //echo $qry;
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into fac_ach_file (fhid,fname) values(".$dd.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
