	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="chk_out.php" class="nav-link" style="font-size:18px;;color:#000">Logout</a></li>
				</ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px"><?php echo $_SESSION['dname']; ?>- Best Practice</h1>
          </div>
        </div>
      </div>
    </section>
                        ...
                        <!--<table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            ...
                            <?php
                                ...
                                /*if(isset($_SESSION['branch']))
                                {
                                    ...
                                    //while($row=mysqli_fetch_array($res))
                                    //{
                                        $did= $_REQUEST['did'];//$row['did'];
                                        echo "<tr>";
                                       echo "<td style='text-align:center'>".$cnt++."</td>";
                                        echo "<td>".$row['dname']."</td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_bp_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_bp.php?did=".$did."&dp='dpt'><img src='images/v2.jpg'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_bp_edit.php?did=".$did."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_bp_del.php?did=".$did."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                   // }
