...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Programme Specific Outcomes</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_prg.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Programme Specific Outcomes</h1>
    						                 ...
    						                 <?php
    						                    ...
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='iq_prg_file.php?fid=<?php echo $row['iq_pid'];?>'>
						            ...
						            <div class="form-group">
						             ...
						             <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_prg.php" style='color:#fff'>Cancel</a></button>
                      ...
                      <div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate">
					        ...
					        <div class="vertical-menu" style="width:100%;font-family:exo">
								...
								<a href="iqac_prg.php" class="active">Programme Specific Outcomes</a>
