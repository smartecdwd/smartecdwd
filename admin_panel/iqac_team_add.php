			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_team_add.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Team List</label>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="insert into iq_team (tm_iqc,status) values('$dbj','$st')";
        $res=mysqli_query($conn,$qry);
        $qry="select max(iq_tid) as fid from iq_team";
        $res=mysqli_query($conn,$qry);
