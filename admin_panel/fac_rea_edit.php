<?php
    ...
    $qry="select * from vw_fac_rea where did=".$did ." and rea_typ like '%".$par."%'";
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="fac_rea_edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Faculty Profile List</label>
    						                 ...
    						                 <?php
    						                    ...
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='fac_rea_file.php?fid=<?php echo $row['fr_fid'];?>&dd=<?php echo $did;?>'>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update fac_research set rea_det='$dbj' where frid=".$df;
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into fac_research_file (frid,fname) values(".$dd.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
