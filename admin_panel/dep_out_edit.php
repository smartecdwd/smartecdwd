<?php
    ...
    $qry="select * from vw_dep_prg_out where did=".$did;
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="dep_out_edit.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Department Programme Specific OutComes</label>
    						                 ...
    						                 <?php
    						                    ...
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='dep_out_file.php?fid=<?php echo $row['do_fid'];?>&dd=<?php echo $did;?>'>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update dep_out_come set out_det='$dbj' where doid=".$df;
        $res=mysqli_query($conn,$qry);
        ...
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into dep_out_come_file (doid,fname) values(".$dd.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
