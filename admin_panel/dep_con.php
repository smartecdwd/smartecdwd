<?php
    ...
    $qry="select * from vw_dep_vis where did=".$did;
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="dep_con.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px"><?php echo $dn; ?> - Contact</h1>
          </div>
        </div>
      </div>
    </section>
                            ...
                            <?php
                                ...
                                /*if(isset($_SESSION['branch']))
                                {
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                    {
                                        ...
                                        echo "<td style='text-align:center'><a href='dep_con_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_con_view.php?did=".$row['did']."&dp='dpt'><img src='images/v2.jpg'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_con_edit.php?did=".$row['did']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_con_del.php?did=".$row['did']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                    }
