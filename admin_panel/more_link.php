...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px">More Links</h1>
          </div>
        </div>
      </div>
    </section>
                        ...
                        <div class="table-responsive">
                            <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                                <tr style="background-color:#9D84B7;color:#fff;text-align:center">
                                    <td>Slno</td>
                                    <td style="width:50%">More Links </td>
                                    <td>Add New</td>
                                    <td>View</td>
                                <!--    <td>Edit</td>
                                    <td>Delete</td>-->
                               ...
                               <tr>
                                    ...
                                    <td>Good Governance Initiatives</td>
                                    <td style='text-align:center'><a href='good_gov_add.php'><img src='https://kud.ac.in/admin_panel/images/add1.png'></a></td>
                                    <td style='text-align:center'><a href='good_gov_view.php'><img src='https://kud.ac.in/admin_panel/images/v2.jpg'> </a></td>
                                   <!-- <td style='text-align:center'><a href='good_gov_edit.php'><img src='https://kud.ac.in/admin_panel/images/ed4.png' style='width:20px'></a></td>
                                    <td style='text-align:center'><a href='good_gov_del.php'><img src='https://kud.ac.in/admin_panel/images/del3.png' style='width:20px'></a></td>
                                -->
                                </tr>
                            <!--    <tr>
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section" style="height:50px;position:absolute;width:100%;left:0;bottom:0">
