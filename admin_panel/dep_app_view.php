...
<html lang="en">
  ...
  <body>
                                   	...
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='dept/app/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section" style="height:50px;position:fixed;bottom:0;left:0;width:100%">
