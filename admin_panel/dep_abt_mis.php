<?php
    ...
    $qry="select * from vw_dep_mis where did=".$did;
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:16px;padding:7px"><?php echo $_SESSION['dname']; ?> - Mission</h1>
          </div>
        </div>
      </div>
    </section>
                                ...
                                /*if(isset($_SESSION['branch']))
                                {
                                    ...
                                    while($row=mysqli_fetch_array($res))
                                    {
                                       ...
                                       echo "<td>".$row['dname']."</td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_ms_add.php?did=".$row['did']."'><img src='images/add1.png'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_mis.php?did=".$row['did']."&dp='dpt'><img src='images/v2.jpg'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_ms_edit.php?did=".$row['did']."'><img src='images/ed4.png' style='width:20px'> </a></td>";
                                        echo "<td style='text-align:center'><a href='dep_abt_ms_del.php?did=".$row['did']."'><img src='images/del3.png' style='width:20px'> </a></td>";
                                    }
