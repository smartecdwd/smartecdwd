	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_nirf.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
                        ...
                        <div class="col-12">
                               <form action="#" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                   	            $qry="select * from iq_nrif_file order by fname "; // where iq_adid=".$fid;
    
                                                $res=mysqli_query($conn,$qry);
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='iqac/nrif/". $row['fname']."' target='_blank'>".$row['fname']."</a>
    						                              </td><td><a href='iqac_nrif_del.php?fid=".$row['iq_gid']."'> <img src='images/x2.png' style='padding:10px'></a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
