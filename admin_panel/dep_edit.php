...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="ckeditor/fonts.css">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:20px;padding:7px"><?php echo $_SESSION['dname'];?> - Department Overview</h1>
                        ...
                        <div class="col-12">
                               <form action="dep_upd.php" method="post" enctype="multipart/form-data">
                                   	...
                                   	<div class="form-group">
            							...
            							<input type="text" name="dn" id="dn" class="form-control" style="font-size:14px" value='<?php echo $dn; ?>' required readonly>
						            </div>
                                    <div class="form-group">
						            ...
						            <div class="row">
    						            <div class="col-md-8 form-group">
    						                 ...
    						                 <?php
    						                    $qry="select * from dep_mas_file where did=".$did;
    						                    $res=mysqli_query($conn,$qry);
    						                    while($row=mysqli_fetch_array($res))
    						                    {?>
    						                       <tr>
    						                           <td><?php echo $row['fname'];?></td>
    						                           <td><a href='dep_del_file.php?fid=<?php echo $row['dmf_id']."&dd=".$row['did']; ?>'><img src="images/x2.png" style="padding:10px"></a> </td>
    						                       </tr>
