                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                    ...
                                   	                    echo "<tr>
                                   	                        <td><a href='iqac_rep_file1.php?rid=".$row['iq_rid']."'>".$row['rep_type']."</a> </td>
                                   	                </tr>";
                                                }
                                   	            /*$qry="select * from iq_rep_file where iq_rid not in(2,3,4) order by fname "; // where iq_adid=".$fid;
