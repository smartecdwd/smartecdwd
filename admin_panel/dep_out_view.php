      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:17px;padding:7px;width:100%"><?php echo $_SESSION['dname']; ?> - Programme Specific OutComes</h1>
                                   	...
                                   	<div class="form-group">
                                   	    ...
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                                ...
                                                {
                                   	                echo "<tr>
                                   	                    <td style='color:#1f75fe'><a href='dept/out/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
