<?php
    ...
    $qry="select * from vw_std where did='".$did."'";
   // echo $qry;
	...
	<section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
		<div class="container">
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-3 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    <div class="row">
                               <form action="dep_upd.php" method="post" enctype="multipart/form-data">
                                   	<div class="form-group col-sm-12">
                                   	    ...
                                   	    <table class="table table-striped" style="width:100%;color:#000;border:1px solid #3579DC;">
                                   	        ...
                                   	        <tr>
                                   	             <?
                                   	                $qry="select * from std_details where ac_yr='".$did."'";
                                   	                //echo $qry;
                                                    $res=mysqli_query($conn,$qry);
                                                    $cnt=1;
                                                    while($row=mysqli_fetch_array($res))
