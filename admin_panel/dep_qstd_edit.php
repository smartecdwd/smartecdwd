<?php
    ...
    $qry="select * from vw_dep_qstd where did=".$did;
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px"><?php echo $_SESSION ['dname'];?> - Qualified Student</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-12 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                            <form action="dep_qstd_edit.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:14px;color:#000">Qualified Students List</label>
                                        ...
                                        <div class="col-md-8 form-group">
    						                 ...
    						                 <?php
    						                    $qry="select * from dep_qstd_file where dqid=".$fid;
    						                    $res=mysqli_query($conn,$qry);
    						                    while($row=mysqli_fetch_array($res))
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='dep_qstd_file.php?fid=<?php echo $row['dqfid'];?>&dd=<?php echo $did;?>'>
						              ...
						              <input type="text" name="dp" value='<?php echo $fid; ?>' style='visibility:hidden'>
						          </div>
                               </form>
                            </div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update dep_qstd set qstd_det='$dbj' where dqid=".$df;
        $res=mysqli_query($conn,$qry);
        for($i=0;$i<4;$i++)
        {
            if($_FILES['f1']['size'][$i]>0)
            {
                ...
                $qry="insert into dep_qstd_file (dqid,fname) values(".$df.",'$file')";
                $res=mysqli_query($conn,$qry);
            }
        }
