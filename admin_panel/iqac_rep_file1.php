	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_rep_view.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:24px;padding:20px">IQAC - Reports</h1>
                               ...
                               <form action="#" method="post" enctype="multipart/form-data">
                                   	<div class="form-group">
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <tr>
                                   	            <td style="font-weight:bold;font-size:18px">IQAC - Reports</td>
                                   	        </tr>
                                   	    </table>
                                   	    <table class="table" style="width:100%;color:#000">
                                   	        <?
                                   	            
                                   	            $qry="select * from iq_rep_file where iq_rid=".$_REQUEST['rid']."  order by fname "; // where iq_adid=".$fid;
                                                ...
                                                while($row=mysqli_fetch_array($res))
                                                {
                                   	                echo "<tr>
                                   	                    <td>".$cnt++ ."</td>
                                   	                    <td style='color:#1f75fe'><a href='iqac/reports/".$row['fname']."' target='_blank'>".$row['fname']."</a> </td>
                                   	                    <td><a href='iq_rep_file.php?frid=".$row['iqr_fid']."&rid=".$row['iq_rid']."'><img src='images/x2.png'></a></td>
                                   	                </tr>";
                                   	            } ?>
                                   	    </table>
                                    </form>
                    ...
                    <div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate" style="background-color:#eee">
					        ...
					        <div class="vertical-menu" style="width:100%">
								...
								<a href="iqac_rep.php" class="active">IQAC Reports </a>					
								<a href="iqac_pol.php">Policies and Guidelines</a>
								<a href="iqac_an_rep.php">IQAC Annnual Reports</a>
