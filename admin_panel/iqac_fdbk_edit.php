...
<html lang="en">
  <head>
    <title>Karnatak University | IQAC - Activities</title>
    <meta charset="utf-8">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="iqac_feedbk_stake.php" class="nav-link active" style="font-size:18px;color:#000">Home</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread" style="font-family:Exo;color:#fff;font-size:18px;padding:7px">IQAC - Feedback of Stake Holders</h1>
			...
			<div class="row d-flex align-items-stretch no-gutters">
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-12">
                               <form action="iqac_fdbk_edit.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Feedback</label>
                                        <textarea id="text_editor"  name="text_editor"><?php echo $dj; ?></textarea>
						            </div>
						            <div class="form-group">
                                        <label class="label" for="name" style="font-size:15px;color:#000;font-weight:bold">Feedback</label>
                                        <select class="form-control" style="font-size:14px" name="fbk">
                                            <?php 
                                                if($fbk=='Stake Holders')
                                                    echo "<option selected>Stake Holders</option>";
                                                else
                                                    echo "<option>Stake Holders</option>";
                                                if($fbk=='Teachers')
                                                    echo "<option selected>Teachers</option>";
                                                else
                                                    echo "<option>Teachers</option>";
                                                if($fbk=='Students')
                                                    echo "<option selected>Students</option>";
                                                else
						            ...
						            <div class="row">
    						            <div class="col-md-8 form-group">
    						                 ...
    						                 <?php
    						                    $qry="select * from iq_fdbk_file order by iq_fbid";
    						                    $res=mysqli_query($conn,$qry);
    						                    while($row=mysqli_fetch_array($res))
    						                    {?>
    						                       <tr>
    						                           ...
    						                           <td>
    						                               <a href='iq_fdbk_file.php?fid=<?php echo $row['iqfb_fid'];?>&dd=<?php echo $did;?>'>
						            ...
						            <div class="form-group">
						             ...
						             <div class="form-group">
						           	...
						           	<div class="form-group" style="padding-top:20px;text-align:center">
						           	    <center><button class="btn btn-danger py-3 px-5"><a href="iqac_feedbk_stake.php" style='color:#fff'>Cancel</a></button>
                      ...
                      <div class="col-md-3 d-flex align-items-stretch">
					    <div class="sidebar-box ftco-animate" style="background-color:#eee">
					        ...
					        <div class="vertical-menu" style="width:100%;font-family:exo">
								...
								<a href="iqac_feedbk_stake.php" class="active">Feedback of Stake Holders </a>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $qry="update iq_fbk set fb_det='$dbj' where iq_fbid=".$dn;
        $res=mysqli_query($conn,$qry);
        ...
        echo "<script>window.location.href='iqac_feedbk_stake.php';</script>";
    }
?>