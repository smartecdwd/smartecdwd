				...
				<div class="col-md-9 p-4 p-md-5 order-md-last bg-light" style="border:1px solid #1eaaf1;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                    ...
                    <div class="col-12">
					    ...
					    <table id="grid" class="table table-bordered" style="font-size:11pt;color:#000;width:100%">
                            <tr>
                                <td><a href="iqac_adv_add.php"><img src="images/add1.png"> </a></td>
                            </tr>
					        <?php
                            ...
                            <tr style="text-align:center">
                                <td style="text-align:left;color:#3229DE;font-weight:bold">IQAC Advisory</td>
                                <td><a href="iqac_adv_view.php?qid=<?php echo $ad; ?>"><img src="images/v2.jpg"> </a></td>
                                <td><a href="iqac_adv_edit.php?qid=<?php echo $ad; ?>"><img src="images/ed4.png" style="width:15%"></a></td>
                                <td><a href="iqac_adv_del.php?qid=<?php echo $ad; ?>"><img src="images/del3.png" ></a></td>
						    </tr>
						   <?php }
						   ?>
					    </table>
