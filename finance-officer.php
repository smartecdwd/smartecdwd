...
include 'db_con.php';
    ...
    $qry="select * from adm_page where design like 'Finance Officer'";
    $res=mysqli_query($conn,$qry);
    $nm="";$dsc="";$imgc="";$ph="";$prf="";$sl="";$qu="";
      ...
      <div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Finance Officer</li>
          </ol>
        </nav>
      </div>
    </div>
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="finance-officer.php" class="active">Finance officer</a>
...
<section class="sectione2">
  <div class="container">
	...
	<div id="menu5" class="container tab-pane active"><br>
        <h3 style="font-family:Trirong;color:#000; font-weight:600;text-align:center">Finance Officer</h3>
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="contains shadow-sm">
                  ...
                  <div class="administration">
                    ...
                    <center><h3 style="height:50px;font-family:'Enriqueta';background-color:#e1ebea;font-size:100%;padding:7px;border-right:5px solid #BB6464;border-left:5px solid #BB6464 ;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:80%"><strong><?php echo $nm;
                            if($qu!="")
                            {
                                echo "<br><small><b>   ".$qu."</b></small>";
                            }
                        ?></strong></h3></center>
