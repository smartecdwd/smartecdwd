                                ...
                                <div id="home" class="container tab-pane active"><br>
                                    <div class="row">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class='sub-menu'><a href='#'>About<div class='fa fa-caret-down right'></div></a>
                                                        			<ul>
                                            							 ...
                                            							 <li><a href="facilities.php?nid=<?php echo $_SESSION['branch']; ?>" class="active">Facilities</a>	</li>
                                        ...
                                        <div class="col-sm-9 mb-3">
                							...
                							?>
                                            <table class="table table-bordered mt-3" id="customers" style="width:100%;background-color:#eee">
                                                <?php
