	  ...
	  <h5 style="text-align:center; padding-top:20px; "><b>DEPARTMENTS</b></h5>
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
				...
				<a href="law.php" class="active" style="background-color:#6495ED">Law</a>
...
<br> -->
      ...
      <div class="col-lg-12">
            <h2 style="font-family:Domine; font-weight:600; text-align:center;font-size:26px">Faculty of Law</h2>
		...
		<?php
				...
				$qry="select * from vw_dep_file where branch='Law' order by dname";
