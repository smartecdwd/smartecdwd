...
<section class="section1">
  <div class="container">
      <h2 class="title_head" style="font-family:Trirong;text-align:center;color:#000">Feedback of Stake Holders</h2>
			    ...
			    <?php
                                ...
                                {
                                    $fid=$row['iq_fbid'];
                                    echo "<div class='col-12 mb-sm-3'>".$row['fb_det']."</div>";
                            ...
                            <?php
                                $qry="select * from iq_fdbk_file where iq_fbid=".$fid."";
                                $res=mysqli_query($conn,$qry);
								$cnt=1;
                                while($row=mysqli_fetch_assoc($res))
                                {
		                            echo "<tr>
									<td><a href='https://www.kud.ac.in/admin_panel/iqac/fdbk/". $row['fname']."'>". $row['fname'] ."</a></td>
									</tr>";
