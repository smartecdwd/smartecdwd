<?php
    ...
    $qry="select * from adm_page where design like 'Registrar (Evaluation)'";
    $res=mysqli_query($conn,$qry);
    $nm="";$dsc="";$imgc="";$ph="";$prf="";$sl="";
      ...
      <div class="col-sm-12">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Registrar (Evaluation)</li>
          </ol>
        </nav>
      </div>
    </div>
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="registrar-evaluation.php" class="active">Registrar (Evaluation)</a>
...
<section class="sectione2">
  <div class="container">
	...
	<div id="menu4" class="container tab-pane active"><br>
        <h3 style="font-family:Trirong;color:#000; font-weight:600;text-align:center">Registrar (Evaluation)</h3>
            <div class="row">
                ...
                <div class="contains shadow-sm">
                  ...
                  <div class="administration">
                    ...
                    <center><h3 style="height:50px;font-family:'Enriqueta';background-color:#e1ebea;font-size:100%;padding:8px;border-right:5px solid #BB6464;border-left:5px solid #BB6464 ;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;width:80%"><strong><?php echo $nm; ?></strong></h3></center>
                        ...
                        <?php 
                            ...
                            <?}else{?>
                                <button class="btn2 view_btn"><a href='https://www.kud.ac.in/file_upload/adm/CV_Dr.HNagaraja.pdf' target="blank">More Details</a></button>
                            <?}?>
                  </div>
