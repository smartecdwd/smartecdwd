...
<div class="inner_page">
  <div class="container">
    <div class="row border_around p-3 text-justify">
           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%;height:-101%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="research-sg.php" class="active">Research Seed Grants</a>
      ...
      <div class="col-sm-6 col-sm-9 director_img">
        <h2 class="title_head" style="font-family:Domine;text-align:center">Research Seed Grant</h2>
        <hr>
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
			            <table id="customers" style="width:80%" align="center">
                            ...
                            <tr>
                                ...
                                <td width="540"><a href="https://www.kud.ac.in/file_upload/research/seed/Research Seed Grant.pdf" target="_blank">Research Seed Grant</a></td>
                            </tr>
                            <tr>
                                <td class="text-center" width="50">2</td>
                                <td width="540"><a href="https://www.kud.ac.in/file_upload/research/seed/Seed Grant proposal list.pdf" target="_blank">Seed Grant Proposal List</a></td>
                            </tr>
