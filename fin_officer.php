    ...
    <div class="row border_around p-3 text-justify">
	  ...
	  <h5 style="text-align:center;color:#BB6464;height:50px;padding:20px;font-size:17px;border-bottom:2px solid #BB6464;font-family:Alice"><b>MORE LINKS</b></h5>
           <br>
            ...
            <div class="vertical-menu pb-4" style="width:100%">
               ...
               <!--<a href="email-directory.php">Email Directory</a>-->
                ...
                <a href="fin_officer.php" class="active">Finance Section</a>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        <h2 class="title_head" style="font-family:Trirong;text-align:center">Finance Section</h2>
        <hr>
        <div class="table-responsive">
		        <table id="customers" style="width:80%" align="center">
                    
                    <tr>
                        <th colspan="2" align="center" width="640">Finance Section</th>
                    </tr>
                    <tr>
                        <td class="text-center" width="50">1</td>
                        <td width="540"> 
                            <a href="file_upload/fin_office/Finance Section Details - KU WEBSITE.pdf" targeet="_blank">Finance Section</a>
                        </td>
                    </tr>
               </table>
            </div>
