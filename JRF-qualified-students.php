 ...
 -->
      <div class="col-lg-12">
                        <?php
                               ...
                               <h2 class="title_head" style="font-family:Domine; font-weight:600; padding-top:30px;"><?php echo $row['dname']; ?> &nbsp;<i class="fa fa-caret-right"></i>JRF Qualified Students</h2>
                              <?php 
		                        }
        ...
        <div id="home" class="container tab-pane active"><br>
            <div class="row">
                <div class="col-lg-12">
                     <?php
                                //$nid=$_REQUEST['nid'];
                                $qry="select * from vw_dep_qstd where did=".$nid." and qstd_type='JRF'";
                                $res=mysqli_query($conn,$qry);
                                $cnt=1;
                                $fid="";
                                while($row=mysqli_fetch_assoc($res))
