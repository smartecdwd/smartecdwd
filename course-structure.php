                            ...
                            <div class="tab-content clearfix">
                                <div id="home" class="container tab-pane active">
                                    <div class="row">
        		                        ...
        		                        <div class="col-sm-9">
                                            <h5 class="mb-3">COURSE STRUCTURE</h5>
                                            <?php
                                                //$nid=$_REQUEST['nid'];
                                                ...
                                                {
							                ?>
                                                    <table class="my-3" id="customers" style="width:80%;" align="center">
        								                <tr>
                                                        ...
                                                        <?php
                                                            ...
                                                            while($row=mysqli_fetch_assoc($res))
                                                            {
                            		                            ...
                            		                            echo "<td><a href='https://www.kud.ac.in/admin_panel/dept/cou/". $row['fname']."' style='color:blue'>Course Structure</a></td>";
                            									echo "</tr>";
                                                            }
                                                        ?>
                                                    </table>
