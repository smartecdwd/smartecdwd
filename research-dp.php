           ...
           <br>
            ...
            <div class="vertical-menu" style="width:100%;height:-101%">
               <!--  <a href="index.php">Home</a> -->
				...
				<a href="research-dp.php" class="active">Departmental Projects</a>
...
<br>
      ...
      <div class="col-sm-6 col-md-9 director_img">
        <h2 class="title_head" style="font-family:Domine;text-align:center">Departmental Projects</h2>
        <hr>
            <div class="row">
                <div class="col-sm-12">
                    <div class="table-responsive">
			            <table id="customers" style="width:80%" align="center">
                            ...
                            <tr>
                                ...
                                <td width="540"><a href="https://www.kud.ac.in/file_upload/research/03 Departmental Projects.pdf" target="_blank">Departmental Projects</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
